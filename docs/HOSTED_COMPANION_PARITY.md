...
| Game shelf | Scans owner-approved local ROM folders and launches local EmulatorJS | Browser-selected owner files, browser saves, no background scanning | “Add a game you own” |
| Saves and backup | Exports/imports selected local groups with a manifest | Exports/imports browser-backed app data selected by the person | “Browser data backup” |
...
| Utility Desk | Local device readings, file hashes, notes, clipboard handoff, Kanban | Notes, Kanban, converters, browser-visible hashes and clipboard handoff | “Local browser workspace” |
