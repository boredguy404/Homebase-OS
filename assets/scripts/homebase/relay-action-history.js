(() => {
  ...
  const boot = () => {
    ...
    dialog.innerHTML = '<div class="relay-action-title"><b>RELAY ACTION</b><button type="button" aria-label="Close action details">×</button></div><header><small></small><h2></h2><p></p></header><ol></ol>';
