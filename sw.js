...
const SHELL=[
  ...
  '/assets/styles/homebase/system-insights.css', '/assets/styles/homebase/neofetch-ambient.css','/assets/styles/homebase/neofetch-retro-readout.css','/assets/styles/homebase/relay-live-build.css','/assets/styles/homebase/project-board-interaction.css','/assets/styles/homebase/relay-free-routes.css','/assets/styles/homebase/window-layering.css','/assets/styles/homebase/about-overview.css','/modules/radio-orbit/theme-inherit-surfaces.css','/assets/styles/shared/retro-window-standard.css', '/assets/styles/homebase/scroll-motion.css',
