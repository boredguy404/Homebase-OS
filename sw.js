...
const SHELL=[
  ...
  '/pages/browse.html', '/pages/game-setup.html', '/pages/game-manager.html', '/pages/console.html', '/version.json', '/modules/radio-orbit/index.html', '/user-apps/games/quest-board/index.html', '/user-apps/games/quest-board/app.json', '/user-apps/games/novashell-world/index.html', '/user-apps/games/novashell-world/app.json', '/user-apps/games/novashell-world/world.css', '/user-apps/games/novashell-world/world3d.js', '/user-apps/games/novashell-world/vendor/three.module.js', '/user-apps/reference/pokedex-browser/index.html', '/user-apps/reference/pokedex-browser/app.json', '/user-apps/reference/pokedex-browser/app.css', '/user-apps/reference/pokedex-browser/app.js', '/modules/radio-orbit/style.css', '/modules/radio-orbit/embedded.css', '/modules/radio-orbit/colorful.css', '/modules/radio-orbit/classic-gray.css', '/modules/radio-orbit/orbit-controls.css', '/modules/radio-orbit/retro-visual-fix.css', '/modules/radio-orbit/orbit-contrast.css', '/modules/radio-orbit/orbit-contrast-plus.css', '/modules/radio-orbit/orbit-channel-rail.css', '/modules/radio-orbit/theme-inherit.css', '/modules/radio-orbit/app.js', '/assets/styles/discovery/browse.css', '/assets/scripts/discovery/browse.js',
  ...
  '/assets/styles/files/dialog.css', '/assets/styles/files/files-mobile-actions.css','/assets/styles/files/gallery.css', '/assets/scripts/files/files-rename.js', '/assets/scripts/files/files-trash-confirm.js', '/assets/scripts/files/files-copy-paste.js', '/assets/scripts/files/files-inapp-actions.js', '/assets/styles/apps/catalog.css',
  ...
  '/assets/scripts/homebase/scroll-motion.js', '/assets/scripts/arcade/game-controls.js', '/assets/scripts/arcade/world-cabinet-handoff.js',
  ...
  '/assets/scripts/discovery/discover.js', '/assets/scripts/discovery/discover-resilience.js', '/assets/scripts/homebase/fake-virus-lab.js', '/assets/scripts/files/files.js','/assets/scripts/files/files-gallery.js',
