export class PixelWorld {
  ...
  addStation(station){const marker=new this.THREE.Group();marker.position.set(station.x,0,station.z);const pad=this.cube(marker,2.6,.08,2.6,'#315f77',0,.06,0,.25);this.scene.add(marker);this.stations.push({...station,marker,pad})}
